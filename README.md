...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rastervision-core-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13418&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rastervision-core-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rastervision-core` can be installed with:

```
conda install rastervision-core
```

It is possible to list all of the versions of `rastervision-core` available on your platform with:
